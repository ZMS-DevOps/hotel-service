...
var file_booking_service_proto_goTypes = []interface{}{
	...
	(*Hotel)(nil),          // 4: booking.Accommodation
}
var file_booking_service_proto_depIdxs = []int32{
	4, // 0: booking.GetResponse.hotel:type_name -> booking.Accommodation
	4, // 1: booking.GetAllResponse.hotels:type_name -> booking.Accommodation
